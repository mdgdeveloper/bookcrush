        ...
        <div className="container mx-auto mt-20">
            <div className="flex justify-center">
                <div className="flex flex-col justify-center items-center w-[600px]">
                    ...
                    <div className="text-5xl font-medium tracking-tight">Tu universo <span className="relative inline-block">
                    ...
                    <div className="text-5xl font-medium tracking">en un solo lugar</div>
